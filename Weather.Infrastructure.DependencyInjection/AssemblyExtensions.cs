...
namespace Weather.Infrastructure.DependencyInjection
{
    internal static class AssemblyExtensions
    {
        ...
        private static Assembly[] GetAssemblyByName(IReadOnlyCollection<string> assemblyNameList)
        {
            return assemblyNameList.Select(Assembly.Load).ToArray();
        }

        private static string[] GetAssemblyNameListByPattern(string appDomainAppPath, string searchPattern)
        {
